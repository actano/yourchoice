...
function _getBottommostSelectedItem(state) {
  ...
  try {
    for (var _iterator2 = state.items[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
...
var _ = __webpack_require__(8).runInContext();
...
var _operations = __webpack_require__(0);
